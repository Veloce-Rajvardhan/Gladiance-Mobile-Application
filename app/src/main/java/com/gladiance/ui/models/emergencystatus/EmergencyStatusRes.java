...
public class EmergencyStatusRes {
    ...
    public EmergencyStatusRes(Boolean successful, String message, String tag, String tagType, String processToken, ObjectTag objectTag) {
        this.successful = successful;
        this.message = message;
        this.tag = tag;
        this.tagType = tagType;
