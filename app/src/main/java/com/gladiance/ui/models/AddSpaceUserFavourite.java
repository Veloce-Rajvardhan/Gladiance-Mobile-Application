...
public class AddSpaceUserFavourite {
    ...
    public AddSpaceUserFavourite(Boolean successful, String message, String tag, String tagType, String processToken, Object objectTag) {
        this.successful = successful;
        this.message = message;
        this.tag = tag;
        this.tagType = tagType;
