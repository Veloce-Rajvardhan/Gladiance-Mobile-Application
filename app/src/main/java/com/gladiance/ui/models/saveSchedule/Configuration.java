...
public class Configuration {
    ...
    public Configuration(Long gAAProjectNodeScheduleRef, Long gAAProjectSpaceTypePlannedDeviceRef, String nodeConfigDeviceName, String nodeConfigParamName, String value) {
