...
public class ObjectTagSchedule {
    ...
    public ObjectTagSchedule(Long ref, String name, Long gAAProjectSpaceTypeRef, String code, Integer isSystemDefinedSchedule, String gAAProjectSpaceTypeName, Long gAAProjectRef, String gAAProjectName, List<Configuration> configurations, List<Trigger> triggers) {
        this.ref = ref;
        this.name = name;
