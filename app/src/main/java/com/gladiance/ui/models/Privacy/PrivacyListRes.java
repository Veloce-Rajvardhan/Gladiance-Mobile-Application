...
public class PrivacyListRes {
    ...
    public PrivacyListRes(Boolean successful, String message, String tag, String tagType, String processToken, List<ObjectTag> objectTag) {
        this.successful = successful;
        this.message = message;
        this.tag = tag;
        this.tagType = tagType;
