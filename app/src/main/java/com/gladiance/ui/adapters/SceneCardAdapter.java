...
public class SceneCardAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public SceneCardAdapter(ArrayList<Devices> arrayList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_TYPE_ONE) {
            ...
            return new SceneCardAdapter.TypeTwoViewHolder(view);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder.getItemViewType() == VIEW_TYPE_ONE) {
            ...
            SceneCardAdapter.TypeTwoViewHolder typeTwoViewHolder = (SceneCardAdapter.TypeTwoViewHolder) holder;
...
//                        transaction.commit();
    ...
    static class TypeTwoViewHolder extends RecyclerView.ViewHolder {
        ...
        SceneDeviceCardFragment sceneDeviceCardFragment = SceneDeviceCardFragment.getInstance();
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION) {
                        ...
                        sceneDeviceCardFragment.sendSwitchState(powerState,name,power);
