...
public class EditMoodActivity extends AppCompatActivity implements AreaSpinnerAdapter.OnAreaSelectedListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        spinner = findViewById(R.id.sceneAreaSpinner);
        buttonSave = findViewById(R.id.saveBtn);
        editTextProjectName = findViewById(R.id.SMProjectName);
        editTextSpaceName = findViewById(R.id.SMSpaceName);
        editTextSceneName = findViewById(R.id.SMSceneName);
        recyclerView = findViewById(R.id.recycleViewDeviceName);
        ...
        SharedPreferences sharedPreferences_ref = getSharedPreferences("Ref_Dyn", Context.MODE_PRIVATE);
        ...
        // Retrieve SharedPreferences object (Ref get)
        SharedPreferences sharedPreferences_name = getSharedPreferences("Name_Dyn", Context.MODE_PRIVATE);
        ...
        // Retrieve SharedPreferences object (Ref get)
        SharedPreferences sharedPreferences_projectspace = getSharedPreferences("PROJECT_SPACE_REF_Dyn", Context.MODE_PRIVATE);
                ...
                call.enqueue(new Callback<SceneResModel>() {
                    ...
                    public void onResponse(Call<SceneResModel> call, Response<SceneResModel> response) {
                        if (response.isSuccessful()) {
                            ...
                            Toast.makeText(getApplicationContext(), "Scene Edited Successfully!", Toast.LENGTH_SHORT).show();
                            Log.e(TAG, "Done ");
                        } else {
        ...
        call.enqueue(new Callback<ProjectAreaLandingResModel>() {
            ...
            public void onResponse(Call<ProjectAreaLandingResModel> call, Response<ProjectAreaLandingResModel> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    AreaSpinnerAdapter adapter = new AreaSpinnerAdapter(context,spinner,areas);

                    // Set the listener for the adapter
                    adapter.setOnAreaSelectedListener(EditMoodActivity.this); // Replace YourFragmentClassName with the name of your fragment class
