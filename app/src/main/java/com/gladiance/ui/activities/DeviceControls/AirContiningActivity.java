...
//            Log.e("APPCONSTS2 power_Schedule",""+AppConstants.Create_power);
        ...
        //// Schedule
        try {
            AppConstants.powerState_Schedule = "Mode";
            AppConstants.power_Schedule = String.valueOf(mood);
...
//            Log.e("APPCONSTS2 power_Schedule",""+AppConstants.Create_power);
        ...
        //// Schedule
        try {
            AppConstants.powerState_Schedule = "Unit";
            AppConstants.power_Schedule = String.valueOf(unit);
            Log.d("TAG", "PowerState2: " + AppConstants.powerState_Schedule);
            Log.d("TAG", "Power2: " + AppConstants.power_Schedule);
